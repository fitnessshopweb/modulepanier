						...
						<div class="col-auto">
							<nav class="main_menu">
								<ul id="example-one">
									...
									<li>
										<a href="blog2.php">Product</a>
										<ul class="sub-menu">
											<li><a href="blog2.php">Productlist</a></li>
											<li><a href="blog2.php">Product Detail</a></li>
										</ul>
									</li>
									<li>
...
<table border="1">
<tr>
<td style="color:black;">Réference de votre commande</td>
<td style="color:black;">Réference du produit</td>
<td style="color:black;">Produit</td>
<td style="color:black;">Quantite</td>
<td style="color:black;">Date</td>
<td style="color:black;">Prix total</td>
...
foreach($listecommandes as $row){
	...
	<td style="color:black;"><?PHP echo $row['id_prod']; ?></td>
	<td style="color:black;"><?PHP echo $row['nom_prod']; ?></td>
	<td style="color:black;"><?PHP echo $row['quantite']; ?></td>
	<td style="color:black;"><?PHP echo $row['date']; ?></td>
	<td style="color:black;"><?PHP echo $row['prix']; ?></td>
	<td style="color:black;"><form method="POST" action="supprimerCommande.php">
	<input type="submit" class="btn btn-danger" name="supprimer" value="supprimer">
	<input type="hidden" value="<?PHP echo $row['id']; ?>" name="id4">
</form>
</td>
...
<td style="color:black;"><?php
             $db = config::getConnexion();
                $a = $db->query("SELECT SUM(prix) from commande");
                while ($result = $a->fetch())

        echo  $result ['SUM(prix)'];
...
<td style="color:black;">Nombre de commandes total</td>
<td style="color:black;"><?php
             $db2 = config::getConnexion();
                $az = $db2->query("SELECT count(*) from commande");
                while ($result = $az->fetch())
...
?> 
                  ...
                  <button type="button"  class="btn btn-primary">Suivre la Livraison</button>
</div>
                </div>
